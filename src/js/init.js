window.onload = function () {
	...
	give.me(["vendor/jquery.js", "vendor/underscore.js", "vendor/backbone.js", "vendor/chico-mobile.js", "src/js/app.min.js"], function () {
		new app.Seeker();
		Backbone.history.start();
	});

	var _gaq=[['_setAccount','UA-15753373-4'],['_trackPageview']];
